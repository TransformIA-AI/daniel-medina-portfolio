...
const cvFiles: Record<string, CvData> = {
  "daniel-medina-sanchez-cv-es.pdf": esCv,
  "daniel-medina-sanchez-cv-en.pdf": enCv,
  "daniel-medina-sanchez-cv-en-no-photo.pdf": {
    ...enCv,
...
function buildPage(data: CvData, page: 1 | 2) {
  ...
  if (page === 1) {
    ...
    lines.push(drawText(es ? "Experiencia profesional" : "Professional experience", 50, y, 13, "F2"));
    y -= 18;
